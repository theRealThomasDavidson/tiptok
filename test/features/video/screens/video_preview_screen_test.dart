...
import 'package:tiptok/features/video/screens/video_preview_screen.dart';
...
void main() {
  ...
  testWidgets('VideoPreviewScreen shows upload and cancel buttons', (tester) async {
  ...
  testWidgets('VideoPreviewScreen handles successful upload', (tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: VideoPreviewScreen(
          videoPath: testVideoPath,
  ...
  testWidgets('VideoPreviewScreen handles upload failure', (tester) async {
